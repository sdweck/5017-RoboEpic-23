...
public class DriveConstants {
    ...
    public static final double MAX_RPM = 312;//should be .5
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(.60, 0, 0,
    ...
    public static double TRACK_WIDTH = 6.26; // in
